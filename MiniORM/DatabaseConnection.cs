namespace MiniORM
{
    ...
    internal class DatabaseConnection
    {
        ...
        public DatabaseConnection(string? connectionString)
        {
            ...
            {
                throw new ArgumentNullException(nameof(connectionString), ConnectionIsNullMessage);
            }
            ...
            where T : class
        {
            ...
            {
                IEnumerable<object?> primaryKeyValues = primaryKeyProperties
                    .Select(c => c.GetValue(entity))
                    .ToArray();

                IEnumerable<SqlParameter> primaryKeyParameters = primaryKeyProperties
                    .Zip(primaryKeyValues, (param, value) => new SqlParameter(param.Name, value))
                    .ToArray();

                IEnumerable<object> rowValues = columnsToUpdate
        ...
        {
            SqlCommand command = new SqlCommand(queryText, this._connection, this._transaction);
